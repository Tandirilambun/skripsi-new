            ...
            <div class="container search-bar" id="container-search" style="visibility:hidden;">
                <div id="search-bar" class="ms-5" style="width:80%; ">
                    <form class="form-search" action="/renstrapage/{periode}" method="POST" style="display: flex">
                        <input type="search" id="search-item" name="searchItem" class="form-control"
                ...
                <button class="close-search btn mx-2 py-0 px-2" id="close-search"
                    style="background:#d2d2d2;height:2rem;border-radius: 100%;" onclick="closeSearch()"><i
            ...
            <ul class="navbar-nav" style="width:auto; justify-content:end; column-gap: 2%">
                @auth
                    <a class="btn navigateBtn p-0 d-flex" aria-current="page" href="/home"
                        style="background-color: transparent; border:none; color:black; align-items:center; width:10rem">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end">
                            <li class="dropdown-item mb-0"> <i class="bi bi-person-fill me-2"></i> {{auth() -> user() -> name}}</li>
                            <li>
