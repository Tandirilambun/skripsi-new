<div class="tab-pane p-4" id="general" role="tabpanel" aria-labelledby="general-tab"
    ...
    <div>
        <nav class="nav nav-underline px-2">
            <button class="nav-link active btnNav mx-2" id="nav-overview-general-tab" data-bs-toggle="tab"
                data-bs-target="#overview-general" type="button" role="tab" aria-controls="nav-overview-general"
                aria-selected="false">Overview</button>
            <button class="nav-link btnNav mx-2" id="nav-summary-general-tab" data-bs-toggle="tab"
                data-bs-target="#summary-general" type="button" role="tab" aria-controls="nav-summary-general"
                aria-selected="false">Summary</button>
        </nav>
        <div class="tab-content">
            <div class="tab-pane active" id="overview-general" role="tabpanel" aria-labelledby="overview-general-tab">
                @foreach ($general_query as $general)
                    <a href="/general-objective/{{ $general->id_general }}" style="text-decoration: none; color:black;">
                                    ...
                                    <div class="progress">
                                        <div class="progress_item">
                                            ...
                                            <div class="progress_bar">
                                                <div class="bar" data-value="{{ round($general_2->avg_capaian) }}"
