            ...
            <div class="col card card-capaian px-0 shadow-sm"
                ...
                <div class="card-body px-0">
                    ...
                    <div class="container container-chart m-0 p-0"
                        ...
                        <div class="circular-progress" id="circular-progress-{{ $capaian->id_capaian_use_of_output }}"
                            data-id={{ $capaian->id_capaian_use_of_output }}>
                            <div class="value-container" id="value-container-{{ $capaian->id_capaian_use_of_output }}"
                                data-id={{ $capaian->id_capaian_use_of_output }}>
                    ...
                    <div style="display: flex; justify-content:center; align-items:center;">
                        <button type="button" class="btn btn-hasil px-4 mt-2" data-bs-toggle="popover"
                            ...
                            <i class="fa-solid fa-circle-info ms-1" style="color:orange; font-size:13px;"></i></button>
                    </div>
                </div>
            </div>

            <!--Modal Update Capaian -->
            <div class="modal fade" id="edit-capaian-use-of-output-{{ $capaian->id_capaian_use_of_output }}" tabindex="-1"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="tahun-capaian"
                                        placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value={{old('tahun_use_of_output', $capaian -> tahun_use_of_output)}}>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="hasil-capaian"
                                        ...
                                        name="hasil_capaian" style="width: 20vh" value={{old('capaian_use_of_output', $capaian -> capaian_use_of_output)}}>
                                </div>
                            </div>
