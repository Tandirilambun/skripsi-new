...
@if (count($capaians_outcome) != 0)
    <div class="row chart">
        ...
        @foreach ($capaians_outcome as $capaian)
            <div class="col card card-capaian px-0 shadow-sm"
                ...
                <div class="card-body px-0">
                    <div class="me-3" id="btn-olah" style="float: right;">
                        <div class="d-flex">
                            <form action="/capaian-indikator-outcome/{{ $capaian->id_capaian_outcome }}"
                                method="post">
                                @method('delete')
                                @csrf
            ...
            <div class="modal fade" id="edit-capaian-outcome-{{ $capaian->id_capaian_outcome }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="tahun-capaian"
                                        placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value={{old('tahun_outcome', $capaian -> tahun_outcome)}}>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="hasil-capaian" min="0"
                                        max="100" placeholder="Hasil Capaian" name="hasil_capaian" style="width: 20vh" value={{old('capaian_outcome',$capaian -> capaian_outcome)}}>
                                </div>
                            </div>
