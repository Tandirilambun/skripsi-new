    ...
    <div>
        <nav class="nav nav-underline px-2">
            <button class="nav-link active btnNav mx-2" id="nav-overview-outcome-tab" data-bs-toggle="tab"
                data-bs-target="#overview-outcome" type="button" role="tab" aria-controls="nav-overview-outcome"
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="overview-outcome" role="tabpanel" aria-labelledby="overview-outcome-tab">
                                    ...
                                    <div class="progress">
                                        <div class="progress_item">
                                            ...
                                            <div class="progress_bar">
                                                <div class="bar" data-value="{{ round($outcome_2->avg_capaian) }}"
