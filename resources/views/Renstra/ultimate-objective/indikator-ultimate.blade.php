<div class="row mt-3 shadow-sm" style="border-radius:20px; background:white;">
    ...
    <div class="col d-flex justify-content-center align-items-center">
        <img src="{{ asset('img/illustration/Risk management-amico.png') }}" alt="company_gif" style="width: 400px; height:400px;">
    </div>
</div>
<div class="row py-3">
    ...
    <div class="col shadow-sm card p-2 border-0 ms-2"
...
@if (count($capaians_ultimate) != 0)
    <div class="row chart">
        <div class="col card px-0" style="max-width: 15rem; border:2px dashed #dadada; border-radius:20px; background:none;">
        ...
        @foreach ($capaians_ultimate as $capaian)
            <div class="col card card-capaian px-0 shadow-sm"
                ...
                <div class="card-body px-0">
                    <div class="me-3" id="btn-olah" style="float: right;">
                        <div class="d-flex">
                            <form action="/capaian-indikator-ultimate/{{ $capaian->id_capaian_ultimate}}"
                                method="post">
                                @method('delete')
                                @csrf
                                <button class="btn btn-olah p-0 me-1 d-flex justify-content-center align-items-center"
                            ...
                            <button type="button"
                                class="btn-olah btn p-0 d-flex justify-content-center align-items-center"
            ...
            <div class="modal fade" id="edit-capaian-ultimate-{{ $capaian->id_capaian_ultimate }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width: 70%">
                    <div class="modal-content">
                        ...
                        <form action="/capaian-indikator-ultimate/{{$capaian -> id_capaian_ultimate}}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="tahun-capaian"
                                        placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value={{old('tahun_ultimate', $capaian -> tahun_ultimate)}}>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input required type="number" class="form-control" id="hasil-capaian" min="0"
                                        max="100" placeholder="Hasil Capaian" name="hasil_capaian" style="width: 20vh" value={{old('capaian_ultimate', $capaian -> capaian_ultimate)}}>
                                </div>
                            </div>
